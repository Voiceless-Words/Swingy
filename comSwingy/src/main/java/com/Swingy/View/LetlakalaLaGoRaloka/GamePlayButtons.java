...
public class GamePlayButtons extends JPanel {
    ...
    public GamePlayButtons() {
        ...
        try {
            _heroPicture = ImageIO.read(new File("/goinfre/pragolan/Desktop/comSwingy/src/main/resources/images/up.jpg"));
            _upImg = new JButton(new ImageIcon(_heroPicture));
            _upImg.setToolTipText("up");
            _heroPicture = ImageIO.read(new File("/goinfre/pragolan/Desktop/comSwingy/src/main/resources/images/down.jpg"));
            _downImg = new JButton(new ImageIcon(_heroPicture));
            _downImg.setToolTipText("down");
            _heroPicture = ImageIO.read(new File("/goinfre/pragolan/Desktop/comSwingy/src/main/resources/images/left.jpg"));
            _leftImg = new JButton(new ImageIcon(_heroPicture));
            _leftImg.setToolTipText("left");
            _heroPicture = ImageIO.read(new File("/goinfre/pragolan/Desktop/comSwingy/src/main/resources/images/right.jpg"));
